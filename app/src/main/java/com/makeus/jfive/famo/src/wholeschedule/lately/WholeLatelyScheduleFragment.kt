...
import com.makeus.jfive.famo.databinding.FragmentScheduleFindLatelyBinding
...
import com.makeus.jfive.famo.src.wholeschedule.lately.adapter.WholeScheduleLatelyAdapter
            ...
            100 -> {
                ...
                if (response.data.size > 0){
                    ...
                    if (testCnt == 0){
                        ...
                        var size5 = 0
                        size5 = dpToPx(requireContext(), 10)

                        var size10 = 0
                        size10 = dpToPx(requireContext(), 3)
